...
contract HoodMarketsV3LpLocker is Ownable, IHoodMarketsV3LpLocker {
    string public constant version = "0.0.2";

    address public positionManager;
    address public factory;

    uint256 public constant TEAM_REWARD = 5;
    ...
    constructor(
        ...
        address tokenFactory_, // Address of the hoodmarkets factory
        address positionManager_, // Address of the position manager
        address teamRecipient_ // address to receive hoodmarkets platform portion of the rewards
    ) Ownable(owner_) {
        ...
        MAX_CREATOR_REWARD = IHoodMarketsV3(factory).MAX_CREATOR_REWARD();
    ...
    function onERC721Received(address, address from, uint256 id, bytes calldata)
        ...
        returns (bytes4)
    {
        // Only HoodMarketsV3 Factory can send NFTs here
        if (from != factory) {
