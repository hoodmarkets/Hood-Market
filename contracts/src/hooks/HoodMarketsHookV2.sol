...
import {IHoodMarketsHookV2PoolExtension} from "./interfaces/IHoodMarketsHookV2PoolExtension.sol";
...
import {IHoodMarketsHookV2} from "./interfaces/IHoodMarketsHookV2.sol";
...
abstract contract HoodMarketsHookV2 is BaseHook, IHoodMarketsHookV2 {
    ...
    IHoodMarketsPoolExtensionAllowlist public immutable poolExtensionAllowlist;
    ...
    constructor(
        ...
        factory = _factory;
        poolExtensionAllowlist = IHoodMarketsPoolExtensionAllowlist(_poolExtensionAllowlist);
        weth = _weth;
    }
    ...
    function _initializePoolExtensionData(
        ...
        if (_poolExtension != address(0)) {
            ...
            IHoodMarketsHookV2PoolExtension(_poolExtension)
        ...
        onlyFactory
    {
        ...
        if (poolExtension[poolKey.toId()] != address(0)) {
            IHoodMarketsHookV2PoolExtension(poolExtension[poolKey.toId()])
    ...
    function supportsInterface(bytes4 interfaceId) external pure returns (bool) {
        return interfaceId == type(ILiquidHook).interfaceId
            || interfaceId == type(IHoodMarketsHookV2).interfaceId;
    }
