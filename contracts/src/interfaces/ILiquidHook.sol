...
interface ILiquidHook {
    ...
    // note: original base ILiquidHook deployment is missing these functions but
    // the ILiquidLpFeeConversion locker needs them
